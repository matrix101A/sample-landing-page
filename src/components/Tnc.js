...
function Tnc() {
  return (
    <div className="terms" style={{ backgroundColor: "white " }}>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to http://localhost:3000/!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of w's Website, located at http://localhost:3000/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use http://localhost:3000/ if you do not
      ...
      <p>
        We employ the use of cookies. By accessing http://localhost:3000/, you
        agreed to use cookies in agreement with the w's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, w and/or its licensors own the intellectual
        property rights for all material on http://localhost:3000/. All
        intellectual property rights are reserved. You may access this from
        http://localhost:3000/ for your own personal use subjected to
        restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from http://localhost:3000/</li>
        <li>Sell, rent or sub-license material from http://localhost:3000/</li>
        <li>
          Reproduce, duplicate or copy material from http://localhost:3000/
        </li>
        <li>Redistribute content from http://localhost:3000/</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. w
        ...
        of w,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, w shall not be liable for the Comments or
      ...
      <p>
        w reserves the right to monitor all Comments and to remove any Comments
      ...
      <p>
        You hereby grant w a non-exclusive license to use, reproduce, edit and
      ...
      <p>
        ...
        the hyperlink compensates the absence of w; and (d) the link is in the
      ...
      <p>
        ...
        e-mail to w. Please include your name, your organization name, contact
      ...
      <p>
        No use of w's logo or other artwork will be allowed for linking absent a
